...
public class EarthMeshController : MonoBehaviour
{
    ...
    private TextSwapContr textswapcontr;
    ...
    Color32 visaReq1color   = new Color32(255, 104, 110, 100); //Visa required; int = 1; redish color #ff686e
    Color32 visaE2color     = new Color32(255, 184, 64, 100); //E-Visa or Preenrollment; int = 2; orange color #ffb840
    Color32 visaOnArr3color = new Color32(242, 245, 134, 100); //Visa on arrival; int = 3; yellow color #f2f586
    Color32 visaFree4color  = new Color32(110, 255, 104, 100); //Visa free; int = 4; green color #6eff68
    ...
    public void Awake()
    {
        ...
        textswapcontr = GameObject.FindObjectOfType<TextSwapContr>();
    }
